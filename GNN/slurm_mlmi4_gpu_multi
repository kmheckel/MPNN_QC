...
# # GAT
# options="--num_epochs=67 --predict_all=True --pre_trained_path=models/2024-03-13_07-09-44/GNN_epoch_39.pt --model_name=gat --num_towers=0 --hidden_channels=180 --initial_lr=1e-4"
# # Command to run
# CMD="python -u run.py $options"
# # Log file for this iteration
# log_file="logs/GAT_spatial_alltargets_run2_batchnorm.$SLURM_JOB_ID"
# # Execute the command and redirect output to log file
# echo "Executing: $CMD > $log_file"
# eval $CMD > $log_file

# # NNConv
# options="--target=11 --model_name=nnconv --num_towers=0 --hidden_channels=74"
# # Command to run
# CMD="python -u run.py $options"
# # Log file for this iteration
# log_file="logs/NNConv_spatial_target_11_run1_batchnorm.$SLURM_JOB_ID"
# # Execute the command and redirect output to log file
# echo "Executing: $CMD > $log_file"
# eval $CMD > $log_file

# # TowerNNConv
# options="--target=11 --model_name=nnconv --num_towers=8 --hidden_channels=200"
# # Command to run
# CMD="python -u run.py $options"
# # Log file for this iteration
# log_file="logs/TowerNNConv_spatial_target_11_run1_batchnorm.$SLURM_JOB_ID"
# # Execute the command and redirect output to log file
# echo "Executing: $CMD > $log_file"
# eval $CMD > $log_file
